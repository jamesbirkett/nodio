...
function register (credentials) {
	if (credentials.access_token || expiresIn <= authenticationTime - moment()) {
...
function _validateMandatoryCredentials (mandatoryCredential) {
	if (!_.has(credentials, mandatoryCredential)) {
...
exports.appID = credentials.app_id;